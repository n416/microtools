...
import { Box, Modal, List, ListItemButton, ListItemText, Typography, ThemeProvider, Button, Grid, Paper } from '@mui/material';
...
function App() {
  ...
  // --- ▼▼▼ ロック機能のための State（localStorage対応） ▼▼▼ ---
  ...
  // --- ▼▼▼ ロック状態を localStorage に保存する Effect ▼▼▼ ---
  useEffect(() => {
  ...
  const handleResetData = () => {
    if (window.confirm('保存されている全てのデータをリセットします。よろしいですか？')) {
      localStorage.clear(); // 保存データを全てクリア
