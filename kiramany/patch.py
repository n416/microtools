...
# src/store.ts を更新して、EVOボタンが選択中のレイヤーに作用するようにします
store_ts_updated = """import { create } from 'zustand';
...
with open(target_path, 'w', encoding='utf-8') as f:
    f.write(store_ts_updated)

print(f"Updated {target_path}: EVO button now targets selected layer if active.")