...
const skillData = [
    { id: 1000, cost: 50, rank: '高級', 双拳銃: 'ダブルショット', 釜: 'クリープスラッシュ', 大剣: 'パワーアタック', 弓: 'スパイラルショット', 杖: 'ランス・オブ・スピリッツ', 鈍器: 'シールドバッシュ', 双剣: 'ラピッドアタック', 宝珠: 'ライトフォール', 御剣: 'マルチプルステップ' },
    { id: 1100, cost: 50, rank: '高級', 双拳銃: 'インパクトショット', 釜: 'スピニングスウィップ', 大剣: 'ショルダーチャージ', 弓: 'ストロングショット', 杖: 'ファイヤーボール', 鈍器: 'ヘビースマッシュ', 双剣: 'ウィンドスラッシュ', 宝珠: 'リカバリー', 御剣: 'トライデントアタック' },
    { id: 1200, cost: 50, rank: '高級', 双拳銃: 'ー', 釜: 'ブラッディフューリー', 大剣: 'アイアンハイド', 弓: 'ー', 杖: 'ブレイズ', 鈍器: 'グレイス・オブ・ライト', 双剣: 'ー', 宝珠: 'チャージングライト', 御剣: 'ー' },
    { id: 2000, cost: 100, rank: '希少', 双拳銃: 'バックワードショット', 釜: 'クルーエルダンス', 大剣: 'フル・レンジ・アタック', 弓: 'ネイチャーアロー', 杖: 'ブラインド', 鈍器: 'ライトニングスマッシャー', 双剣: 'フラッシュクローサー', 宝珠: 'ストレートインパクト', 御剣: 'スクリューヒット' },
    { id: 2100, cost: 100, rank: '希少', 双拳銃: 'クラスターボム', 釜: 'バニッシュスラッシュ', 大剣: 'チェーンリッパー', 弓: 'トライアルオウェンス', 杖: 'ライトニングインパクト', 鈍器: 'ディヴァインリカバリー', 双剣: 'デュアルインベイル', 宝珠: 'ダークネス', 御剣: 'サンダーボルト' },
    { id: 2200, cost: 100, rank: '希少', 双拳銃: 'ラジアル・デス・ゾーン', 釜: 'スウィッピングバッシュ', 大剣: 'フレイムウェーブ', 弓: 'ウェーブアロー', 杖: 'アイススピア', 鈍器: 'シールドビーム', 双剣: 'ピアッシングインパクト', 宝珠: 'レコニングピラー', 御剣: 'スピニングブレイド' },
    { id: 3100, cost: 400, rank: '英雄', 双拳銃: 'クリティカルショット', 釜: 'ジャッジメントシーズ', 大剣: 'ビーストハウル', 弓: 'ブラックアウトショット', 杖: 'メテオショック', 鈍器: 'ディヴァインアイギス', 双剣: 'シリアスウーンズ', 宝珠: 'プライムプロテクト', 御剣: 'トワーリングブレイド' }, // ID 3100
    { id: 3000, cost: 400, rank: '英雄', 双拳銃: 'ガトリングガン', 釜: 'ソウルクリプル', 大剣: 'ダウンフォール', 弓: 'ドッジフォーカス', 杖: 'ブラストフリーズ', 鈍器: 'セイクリッドエフェクト', 双剣: 'エネミーチェイス', 宝珠: 'シャイニングライト', 御剣: 'マジカルバリア' }, // ID 3000
    { id: 3200, cost: 400, rank: '英雄', 双拳銃: 'ラッシュ・オブ・デス', 釜: 'ー', 大剣: 'ー', 弓: 'ドラスティックシューティング', 杖: 'エクスティンクションスペル', 鈍器: 'ー', 双剣: 'スウィフトブレイド', 宝珠: 'ホーリーストレングス', 御剣: 'リーサルトレイル' },
    { id: 4000, cost: 1000, rank: '古代', 双拳銃: 'キラースピリッツ', 釜: 'ブラッディランペイジ', 大剣: 'ビリーフ・オブ・ウォーリアー', 弓: 'スウィフトシュート', 杖: 'アウェイクンインパクト', 鈍器: 'ソウルフォースブレッシング', 双剣: 'クリムゾンポジション', 宝珠: 'アブソリュートブレッシング', 御剣: 'フォースサークル' },
    { id: 4100, cost: 1000, rank: '古代', 双拳銃: 'ファントムシューター', 釜: 'イグナイトクラッシュ', 大剣: 'アースクエイク', 弓: 'シューティングステラ', 杖: 'ドラゴンストライク', 鈍器: 'サクリファイスシールド', 双剣: 'フェニックススラッシュ', 宝珠: 'パワー・オブ・ダークネス', 御剣: 'フォーカスアタック' },
    { id: 4200, cost: 1000, rank: '古代', 双拳銃: 'ブレット・オブ・フロスト', 釜: 'ブラッディエリア', 大剣: 'ブレイドディセント', 弓: 'ツールビヨンショット', 杖: 'フェイテッドスピア', 鈍器: 'シールドインパクト', 双剣: 'アブソリュートイベイジョン', 宝珠: 'リベルフォース', 御剣: 'ボミングソード' },
    { id: 1500, cost: 50, rank: '高級/パッシブ', 双拳銃: 'ブレス・オブ・フォーカス', 釜: 'レイジロア', 大剣: 'ブレイブハート', 弓: 'スナイパーブロー', 杖: 'マナドレイン', 鈍器: 'エキスパートディフェンダー', 双剣: 'ブロウアップ', 宝珠: 'フォーカス・オン・スペル', 御剣: 'コンテンプレーション' },
    { id: 1600, cost: 50, rank: '高級/パッシブ', 双拳銃: 'ホークアイ', 釜: 'アキュレイトインパクト', 大剣: 'アウトバースト', 弓: 'イリュージョンステップ', 杖: 'ネイチャープロージョン', 鈍器: 'フォーカス・オン・ザ・バトル', 双剣: 'ラッキーステップ', 宝珠: 'ライトアーマー', 御剣: 'イラボレートコントロール' },
    { id: 2800, cost: 100, rank: '希少/パッシブ', 双拳銃: 'デュアルガンデキスパート', 釜: 'サイズエキスパート', 大剣: 'ソードエキスパート', 弓: 'ボウエキスパート', 杖: 'スタッフエキスパート', 鈍器: 'メイスエキスパート', 双剣: 'デュアルソードエキスパート', 宝珠: 'オーブエキスパート', 御剣: 'フォースソードエキスパート' },
    { id: 2500, cost: 100, rank: '希少/パッシブ', 双拳銃: 'オーバーヒット', 釜: 'レンジァヴォイド', 大剣: 'ラストガーディアン', 弓: 'マジカルシールド', 杖: 'スペル・オブ・ヴォイド', 鈍器: 'イベイジョン', 双剣: 'ブレイドレゾナンス', 宝珠: 'ウェザーアウェイ', 御剣: 'オーバーカム' },
    { id: 2600, cost: 100, rank: '希少/パッシブ', 双拳銃: 'レジストシールド', 釜: 'ドレインブラッド', 大剣: 'ディヴァインブレイド', 弓: 'シャープアイズ', 杖: 'ファインドエゴ', 鈍器: 'リカバリーエフェクト', 双剣: 'ライズディフェンス', 宝珠: 'フォーカスライト', 御剣: 'アイアンローブ' },
    { id: 2700, cost: 100, rank: '希少/パッシブ', 双拳銃: 'ー', 釜: 'コンセントレーション', 大剣: 'パームフロント', 弓: 'ストレートエイム', 杖: 'ー', 鈍器: 'ホーリープロテクト', 双剣: 'ディープピアース', 宝珠: 'ー', 御剣: 'ー' },
    { id: 3500, cost: 400, rank: '英雄/パッシブ', 双拳銃: 'ウィル・オブ・リベンジ', 釜: 'エンレイジ', 大剣: 'コンバットバスター', 弓: 'ブレス・オブ・ウィング', 杖: 'エレメンタルクエイク', 鈍器: 'メイスマスタリー', 双剣: 'エクシードマインド', 宝珠: 'スピリットインサイド', 御剣: 'スーペリアブロック' },
    { id: 3600, cost: 400, rank: '英雄/パッシブ', 双拳銃: 'コンバットホリック', 釜: 'バイトイリュージョン', 大剣: 'リパルシブフォース', 弓: 'ウィンド・オブ・フォーチュン', 杖: 'クリティカルブースター', 鈍器: 'マインドコントロール', 双剣: 'ブラッドコンシューム', 宝珠: 'ギフト・オブ・グレイス', 御剣: 'インスティンクト・オブ・ファイト' },
    { id: 3700, cost: 400, rank: '英雄/パッシブ', 双拳銃: 'ー', 釜: 'ブリード・トゥー・デス', 大剣: 'ウィークネスディテクション', 弓: 'スペルパニッシュメント', 杖: 'エレメンタルバッシュ', 鈍器: 'ピアースアタック', 双剣: 'エッジブレイド', 宝珠: 'ネイチャーエコー', 御剣: 'ー' },
    { id: 3800, cost: 400, rank: '英雄/パッシブ', 双拳銃: 'ユニーク・デュアルガン・エキスパート', 釜: 'ユニーク・サイズ・エキスパート', 大剣: 'ユニーク・ソード・エキスパート', 弓: 'ユニーク・ボウ・エキスパート', 杖: 'ユニーク・スタッフ・エキスパート', 鈍器: 'ユニーク・メイス・エキスパート', 双剣: 'ユニーク・デュアルソード・エキスパート', 宝珠: 'ユニーク・オーブ・エキスパート', 御剣: 'ー' },
    { id: 4600, cost: 1000, rank: '古代/パッシブ', 双拳銃: 'ミラーアーマー', 釜: 'ブラッドデザイア', 大剣: 'ブレスドプロテクター', 弓: 'マナリカバリー', 杖: 'ソウルメディテーション', 鈍器: 'カルマ', 双剣: 'ディバウトブラッド', 宝珠: 'プレゼント・アン・アンフォーチュン', 御剣: 'ソード・オブ・カース' }, // ID 4600
    { id: 4500, cost: 1000, rank: '古代/パッシブ', 双拳銃: 'カース・オブ・ウィークネス', 釜: 'ブロークンフェイト', 大剣: 'シャイニングリカバリー', 弓: 'ウィークネスフォーカシング', 杖: 'アンプリファイヤー', 鈍器: 'アンブロークンマインド', 双剣: 'アブソリュートブレイド', 宝珠: 'イネイトガード', 御剣: 'ブリーズスペル' } // ID 4500
];
