...
const skillData = [
  // (データは変更なし)
  { id: 1000, rank: '高級', 双拳銃: 'ダブルショット', 鎌: 'クリープスラッシュ', 大剣: 'パワーアタック', 弓: 'スパイラルショット', 杖: 'ランス・オブ・スピリッツ', 鈍器: 'シールドバッシュ', 鎌: 'ラピッドアタック', 宝珠: 'ライトフォール' },
  { id: 1100, rank: '高級', 双拳銃: 'インパクトショット', 鎌: 'スピニングスウィップ', 大剣: 'ショルダーチャージ', 弓: 'ストロングショット', 杖: 'ファイヤーボール', 鈍器: 'ヘビースマッシュ', 鎌: 'ウィンドスラッシュ', 宝珠: 'リカバリー' },
  { id: 1200, rank: '高級', 双拳銃: 'ー', 鎌: 'ブラッディフューリー', 大剣: 'アイアンハイド', 弓: 'ー', 杖: 'ブレイズ', 鈍器: 'グレイス・オブ・ライト', 鎌: 'ー', 宝珠: 'チャージングライト' },
  { id: 2000, rank: '希少', 双拳銃: 'バックワードショット', 鎌: 'クルーエルダンス', 大剣: 'フル・レンジ・アタック', 弓: 'ネイチャーアロー', 杖: 'ブラインド', 鈍器: 'ライトニングスマッシャー', 鎌: 'フラッシュクローサー', 宝珠: 'ストレートインパクト' },
  { id: 2100, rank: '希少', 双拳銃: 'クラスターボム', 鎌: 'バニッシュスラッシュ', 大剣: 'チェーンリッパー', 弓: 'トライアルオウェンス', 杖: 'ライトニングインパクト', 鈍器: 'ディヴァインリカバリー', 鎌: 'デュアルインベイル', 宝珠: 'ダークネス' },
  { id: 2200, rank: '希少', 双拳銃: 'ラジアル・デス・ゾーン', 鎌: 'スウィッピングバッシュ', 大剣: 'フレイムウェーブ', 弓: 'ウェーブアロー', 杖: 'アイススピア', 鈍器: 'シールドビーム', 鎌: 'ピアッシングインパクト', 宝珠: 'レコニングピラー' },
  { id: 3000, rank: '英雄', 双拳銃: 'ガトリングガン', 鎌: 'ソウルクリプル', 大剣: 'ダウンフォール', 弓: 'ドッジフォーカス', 杖: 'ブラストフリーズ', 鈍器: 'セイクリッドエフェクト', 鎌: 'エネミーチェイス', 宝珠: 'シャイニングライト' },
  { id: 3100, rank: '英雄', 双拳銃: 'クリティカルショット', 鎌: 'ジャッジメントシーズ', 大剣: 'ビーストハウル', 弓: 'ブラックアウトショット', 杖: 'メテオショック', 鈍器: 'ディヴァインアイギス', 鎌: 'シリアスウーンズ', 宝珠: 'プライムプロテクト' },
  { id: 3200, rank: '英雄', 双拳銃: 'ラッシュ・オブ・デス', 鎌: 'ー', 大剣: 'ー', 弓: 'ドラスティックシューティング', 杖: 'エクスティンクションスペル', 鈍器: 'ー', 鎌: 'スウィフトブレイド', 宝珠: 'ホーリーストレングス' },
  { id: 4000, rank: '古代', 双拳銃: 'キラースピリッツ', 鎌: 'ブラッディランペイジ', 大剣: 'ビリーフ・オブ・ウォーリアー', 弓: 'スウィフトシュート', 杖: 'アウェイクンインパクト', 鈍器: 'ソウルフォースブレッシング', 鎌: 'クリムゾンポジション', 宝珠: 'アブソリュートブレッシング' },
  { id: 4100, rank: '古代', 双拳銃: 'ファントムシューター', 鎌: 'イグナイトクラッシュ', 大剣: 'アースクエイク', 弓: 'シューティングステラ', 杖: 'ドラゴンストライク', 鈍器: 'サクリファイスシールド', 鎌: 'フェニックススラッシュ', 宝珠: 'パワー・オブ・ダークネス' },
  { id: 4200, rank: '古代', 双拳銃: 'ブレット・オブ・フロスト', 鎌: 'ー', 大剣: 'ブレイドディセント', 弓: 'ツールビヨンショット', 杖: 'フェイテッドスピア', 鈍器: 'シールドインパクト', 鎌: 'アブソリュートイベイジョン', 宝珠: 'リベルフォース' },
  { id: 1500, rank: '高級/パッシブ', 双拳銃: 'ブレス・オブ・フォーカス', 鎌: 'レイジロア', 大剣: 'ブレイブハート', 弓: 'スナイパーブロー', 杖: 'マナドレイン', 鈍器: 'エキスパートディフェンダー', 鎌: 'ブロウアップ', 宝珠: 'フォーカス・オン・スペル' },
  { id: 1600, rank: '高級/パッシブ', 双拳銃: 'ホークアイ', 鎌: 'アキュレイトインパクト', 大剣: 'アウトバースト', 弓: 'イリュージョンステップ', 杖: 'ネイチャープロージョン', 鈍器: 'フォーカス・オン・ザ・バトル', 鎌: 'ラッキーステップ', 宝珠: 'ライトアーマー' },
  { id: 2500, rank: '希少/パッシブ', 双拳銃: 'オーバーヒット', 鎌: 'レンジァヴォイド', 大剣: 'ラストガーディアン', 弓: 'マジカルシールド', 杖: 'スペル・オブ・ヴォイド', 鈍器: 'イベイジョン', 鎌: 'ブレイドレゾナンス', 宝珠: 'ウェザーアウェイ' },
  { id: 2600, rank: '希少/パッシブ', 双拳銃: 'レジストシールド', 鎌: 'ドレインブラッド', 大剣: 'ディヴァインブレイド', 弓: 'シャープアイズ', 杖: 'ファインドエゴ', 鈍器: 'リカバリーエフェクト', 鎌: 'ライズディフェンス', 宝珠: 'フォーカスライト' },
  { id: 2700, rank: '希少/パッシブ', 双拳銃: 'ー', 鎌: 'コンセントレーション', 大剣: 'パームフロント', 弓: 'ストレートエイム', 杖: 'ー', 鈍器: 'ホーリープロテクト', 鎌: 'ディープピアース', 宝珠: 'ー' },
  { id: 2800, rank: '希少/パッシブ', 双拳銃: 'デュアルガンデキスパート', 鎌: 'サイズエキスパート', 大剣: 'ソードエキスパート', 弓: 'ボウエキスパート', 杖: 'スタッフエキスパート', 鈍器: 'メイスエキスパート', 鎌: 'デュアルソードエキスパート', 宝珠: 'オーブエキスパート' },
  { id: 3500, rank: '英雄/パッシブ', 双拳銃: 'ウィル・オブ・リベンジ', 鎌: 'エンレイジ', 大剣: 'コンバットバスター', 弓: 'ブレス・オブ・ウィング', 杖: 'エレメンタルクエイク', 鈍器: 'メイスマスタリー', 鎌: 'エクシードマインド', 宝珠: 'スピリットインサイド' },
  { id: 3600, rank: '英雄/パッシブ', 双拳銃: 'コンバットホリック', 鎌: 'バイトイリュージョン', 大剣: 'リパルシブフォース', 弓: 'ウィンド・オブ・フォーチュン', 杖: 'クリティカルブースター', 鈍器: 'マインドコントロール', 鎌: 'ブラッドコンシューム', 宝珠: 'ギフト・オブ・グレイス' },
  { id: 3700, rank: '英雄/パッシブ', 双拳銃: 'ー', 鎌: 'ブリード・トゥー・デス', 大剣: 'ウィークネスディテクション', 弓: 'スペルパニッシュメント', 杖: 'エレメンタルバッシュ', 鈍器: 'ピアースアタック', 鎌: 'エッジブレイド', 宝珠: 'ネイチャーエコー' },
  { id: 3800, rank: '英雄/パッシブ', 双拳銃: 'ユニーク・デュアルガン・エキスパート', 鎌: 'ユニーク・サイズ・エキスパート', 大剣: 'ユニーク・ソード・エキスパート', 弓: 'ユニーク・ボウ・エキスパート', 杖: 'ユニーク・スタッフ・エキスパート', 鈍器: 'ユニーク・メイス・エキスパート', 鎌: 'ユニーク・デュアルソード・エキスパート', 宝珠: 'ユニーク・オーブ・エキスパート' },
  { id: 4500, rank: '古代/パッシブ', 双拳銃: 'カース・オブ・ウィークネス', 鎌: 'ブロークンフェイト', 大剣: 'シャイニングリカバリー', 弓: 'ウィークネスフォーカシング', 杖: 'アンプリファイヤー', 鈍器: 'アンブロークンマインド', 鎌: 'アブソリュートブレイド', 宝珠: 'イネイトガード' },
  { id: 4600, rank: '古代/パッシブ', 双拳銃: 'ミラーアーマー', 鎌: 'ブラッドデザイア', 大剣: 'ブレスドプロテクター', 弓: 'マナリカバリー', 杖: 'ソウルメディテーション', 鈍器: 'カルマ', 鎌: 'ディバウトブラッド', 宝珠: 'プレゼント・アン・アンフォーチュン' }
];
